...
final class CarouselTest extends TestCase
{
    public function testContainerOptions(): void
    {
        ...
        $expected = <<<HTML
<div id="w0-carousel" class="carousel slide" data-bs-ride="carousel">
<ol class="carousel-indicators"><li class="active" data-bs-target="#w0-carousel" data-bs-slide-to="0"></li>
<li data-bs-target="#w0-carousel" data-bs-slide-to="1"></li>
<li data-bs-target="#w0-carousel" data-bs-slide-to="2"></li></ol>
...
<a class="carousel-control-prev" href="#w0-carousel" data-bs-slide="prev" role="button"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="visually-hidden">Previous</span></a>
<a class="carousel-control-next" href="#w0-carousel" data-bs-slide="next" role="button"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="visually-hidden">Next</span></a>
</div>

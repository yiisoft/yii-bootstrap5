...
For example, you may use [[Yiisoft\Yii\Bootstrap4\Button::options]] to customize the appearance of a button.
...
For example, the widget [[Yiisoft\Yii\Bootstrap4\ButtonGroup]] uses 'btn-group' class for the container div by default,
